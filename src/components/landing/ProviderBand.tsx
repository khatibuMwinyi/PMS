      ...
      <div className="mx-auto max-w-editorial px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-body-lg text-text-secondary mb-8 max-w-lg">{PROVIDER_BAND.body}</p>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="bg-surface-card/10 border border-white/10 rounded-xl px-10 py-8 text-center">
              ...
              <p className="text-body-lg text-text-secondary mt-2 max-w-xs">{PROVIDER_BAND.highlight.caption}</p>
            </div>
          </div>
        </div>
      </div>
