    ...
    >
      ...
      <div className="relative w-full overflow-hidden" style={{ aspectRatio: '4/3' }}>
        ...
        <div className="absolute bottom-0 left-0 right-0 px-4 pb-4 pt-2">
          <h3
            className="text-body-lg leading-tight font-semibold text-white mb-1 line-clamp-1"
          ...
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-caption line-clamp-1" style={{ color: 'rgba(255,255,255,0.62)' }}>
      ...
      <div className="flex items-center justify-between px-4 py-3 border-t border-[var(--border-subtle)]">
        ...
        <span
          className="text-caption font-semibold tracking-wide transition-colors duration-200 group-hover:text-[var(--brand-gold)]"
          style={{ color: 'var(--text-muted)' }}
        >
          View →
        </span>
